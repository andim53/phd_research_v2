#!/bin/sh
# Run A — leaf 2_3x3_30P: novelty+force filter + DFT re-opt (independent, self-contained).
...
# Produces this leaf's single opt_novel_2_3x3_30P.traj.
#
...
# Stage 2: DFT re-opt this leaf's selected minima -> opt_novel_2_3x3_30P.traj
