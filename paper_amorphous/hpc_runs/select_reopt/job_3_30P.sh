#!/bin/sh
# Run A — leaf 3_30P: novelty+force filter + DFT re-opt (independent, self-contained).
...
# Produces this leaf's single opt_novel_3_30P.traj.
#
#   pjsub job_3_30P.sh
...
# Stage 2: DFT re-opt this leaf's selected minima -> opt_novel_3_30P.traj
