#!/bin/sh
# Run A — leaf 1_3x3_20P: novelty+force filter + DFT re-opt (independent, self-contained).
...
# Produces this leaf's single opt_novel_1_3x3_20P.traj.
#
...
# Stage 2: DFT re-opt this leaf's selected minima -> opt_novel_1_3x3_20P.traj
