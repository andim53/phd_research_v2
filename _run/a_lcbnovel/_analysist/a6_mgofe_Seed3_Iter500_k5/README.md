# Run a6 — Novelty-LCB Fe/MgO search (seed 3, 500 iterations, kappa=5)
...
- `SEED = 3`, `N_ITERATIONS = 500`, `KAPPA = 5` (set in `j_novEperAtom.sh`)
...
```
j_novEperAtom.sh    # PJM batch script (seed 3, 500 iterations, kappa=5)
