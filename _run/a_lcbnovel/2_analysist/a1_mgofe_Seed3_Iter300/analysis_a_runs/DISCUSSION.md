...
Analysis dir: `2_analysist/a1_mgofe_Seed3_Iter300/analysis_a_runs`
Produced by: `2_analysist/run_analysis_a_runs.py` (v1.0.0)

## Running script

The exact command that produced this analysis (run from
`/home/think/Desktop/research/_run/a_lcbnovel/2_analysist`, `agox_v2` env):
