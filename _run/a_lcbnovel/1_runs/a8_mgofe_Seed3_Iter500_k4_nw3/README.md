# Run a8 — Novelty-LCB Fe/MgO search (seed 3, 500 iter, kappa=4, novelty_weight=3.0)
...
- `SEED = 3`, `N_ITERATIONS = 500`, `KAPPA = 4`, `NOVELTY_WEIGHT = 3` (set in
  `j_novEperAtom.sh`)
...
```
j_novEperAtom.sh    # PJM batch script (seed 3, 500 iter, kappa=4, novelty_weight=3)
