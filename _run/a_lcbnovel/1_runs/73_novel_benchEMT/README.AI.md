...
- **Dir:** `/home/think/Desktop/research/_run/a_lcbnovel/1_runs/73_novel_benchEMT/`
...
- Earlier single-config benchmark: `2_analysist/1_result/73_novel_benchEMT/`
  (5 seeds, 30 iterations, λ=1.5 — the run this grid extends).
- Related sweep: `2_analysist/1_result/74_novel_benchSweep/`
