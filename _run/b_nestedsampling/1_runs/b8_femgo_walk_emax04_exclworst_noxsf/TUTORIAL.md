...
`1_runs/b8_femgo_walk_emax04_exclworst_noxsf/`: **plain Fe/MgO** (13 seeds),
...
```bash
cd /home/think/Desktop/research/_run/b_nestedsampling/1_runs/b8_femgo_walk_emax04_exclworst_noxsf
