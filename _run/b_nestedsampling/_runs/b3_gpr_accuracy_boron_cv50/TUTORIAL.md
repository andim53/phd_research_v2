...
dataset — identical parameters to `_runs/b1_gpr_accuracy_cv10_bin005`, but on
...
smaller 496-structure set. Higher CV → robust held-out pooling but **slower**
(50 GPR trainings — expect several hours on HPC).
