...
`_runs/b11_boron_walk_emax04_exclworst_noxsf_novelty/`: **B-doped Fe/MgO** (5 seeds,
...
```bash
cd /home/think/Desktop/research/_run/b_nestedsampling/_runs/b11_boron_walk_emax04_exclworst_noxsf_novelty
# iter 5000
