...
/home/think/miniconda3/envs/agox_v2/bin/python main.py \
    ...
    --n-live 100 --n-iters 5000 --perturb 0.01 --perturb-symbols Fe \
    --e-max-per-atom 0.4 \
...
`..._iter10000` / `..._iter20000` output dir.
...
- `--n-iters 5000/10000/20000` — the swept variable: how many NS iterations (how much of the
  prior volume is consumed, `X_final = exp(-n_iters/n_live)`). The convergence study compares
  `log Z` across these three.
