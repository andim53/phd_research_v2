...
| File | Version | Notes |
|------|---------|-------|
| `codes/common.py` | 1.3.0 | ACCEPTED style: owner's sans-serif rcParams; inner (top/right) ticks removed |
...
| `codes/draw_landscape.py` | 1.2.0 | Fig_ConDen (reads Fig_ConDen.json; rel-E axis cap 0.7) |
| `codes/draw_boltzmann.py` | 1.2.0 | Fig_Boltz (reads Fig_Boltz.json; rel-E cap 0.7) |
| `codes/draw_dos.py` | 1.1.0 | Fig_dos (reads Fig_dos.json) |
| `codes/draw_state_density_conv.py` | 1.3.0 | Fig_convStateDens (reads JSON; Run 1–13; rel-E cap 0.7) |
| `codes/draw_si_mgo.py` | 1.2.0 | Fig_mgo (reads Fig_mgo.json; rel-E cap 0.7) |
