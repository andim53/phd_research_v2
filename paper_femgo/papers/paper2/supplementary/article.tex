...
\begin{center}
\begin{tabular}{c}
\includegraphics[height=7.5cm]{../../../analysis/figures/Fig_env.png}
\end{tabular}
\end{center}
\caption 
...
\begin{center}
\begin{tabular}{c}
\includegraphics[height=8.5cm]{../../../analysis/figures/Fig_sup.png}
\end{tabular}
\end{center}
\caption 
{ \label{Fig_sup} Ground-state configurations of $\text{Fe}$ (green spheres) on top of the underlying $\text{MgO(001)}$ monolayer substrate ($\text{Mg}$ in orange, $\text{O}$ in red) for the (a) $3\times3$ and (b) $4\times4$ supercells. The $\text{Fe}$ atoms are color-graded by height above the substrate: the color darkens progressively with increasing height, mapping the relative island height $\Delta Z = Z_{\text{Fe, top}} - Z_{\text{Fe, bottom}}$ (darker = higher). The ground states exhibit $\Delta Z \approx 1.56\text{ \AA}$ for the $3\times3$ supercell (a) and $\Delta Z \approx 3.53\text{ \AA}$ for the $4\times4$ supercell (b), confirming the island growth mode and its height increase with supercell area. The dashed outlines demarcate the periodic boundaries of the respective supercells.} 
\end{figure} 

\begin{figure}
\begin{center}
\begin{tabular}{c}
\includegraphics{../../../analysis/figures/Fig_mgo.png}
\end{tabular}
\end{center}
\caption 
