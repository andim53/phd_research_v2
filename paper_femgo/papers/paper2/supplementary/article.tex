...
\includegraphics[height=3.5cm]{../../../analysis/figures/Fig_env_a.png} &
\includegraphics[height=3.5cm]{../../../analysis/figures/Fig_env_b.png}\\[0.1cm]
\small (a) & \small (b) \\
\end{tabular}
\end{center}
\caption 
