...
Groups:
  ...
  latt_on_mgo    : 32, 33, 34, 35, 36   (32_dos has no seed dirs -> flat-mode)
  ml_rattle      : 67, 68, 69

Run from /home/Desktop/research/_analysist with the agox_v2 conda env:
  /home/miniconda3/envs/agox_v2/bin/python run_analysis_indices.py
  /home/miniconda3/envs/agox_v2/bin/python run_analysis_indices.py --indices latt_sweep_1 --e-max 0.8
  /home/miniconda3/envs/agox_v2/bin/python run_analysis_indices.py --idx 22 --normalize-density
"""
import os
import sys
import argparse
...
# ---------------------------------------------------------------------------
FOLDER_MAP = {
    18:'18_kappa2_iter100_trajNoSave_repSeedDat101',
    19:'19_kappa2_iter100_trajNoSave_repSeedDat0_5x5',
    20:'20_kappa2_iter100_trajNoSave_repSeedDat0_4x4',
...
def main():
    ...
    parser.add_argument('--indices', type=str, default=None,
                        help="Comma-separated indices or group names "
                             "(latt_sweep_1, fe_concentration, latt_on_mgo, "
                             "ml_rattle). Default: all.")
