...
to answer, because exploring it with density functional theory (DFT) alone would require evaluating
far too many structures. Two features of the problem make it tractable. First, the question is specifically
