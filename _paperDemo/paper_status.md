...
| Island origin is strain relief, not interfacial re-hybridisation | analysis/pdos_site_metrics.csv | island interface Fe d-centre +0.47 (not flat-like −0.23) | yes — refines the picture |
