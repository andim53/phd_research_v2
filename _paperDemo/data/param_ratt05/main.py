...
for seed in range(3, 105):
    ...
    # === Build Stacks ===
    slab_mgofe = build_mgo_stack(slab_fe_base, num_layers=mgo_layer_number, vacuum=vacuum, output_path=f"{path_xsf}/slab_mgofe.xsf", rotate_system=False)
